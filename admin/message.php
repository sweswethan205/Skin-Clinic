...
<body class="bg-brand-canvas dark:bg-gray-950 text-slate-700 dark:text-gray-100 min-h-screen flex antialiased">
        ...
        <main class="flex-grow p-4 sm:p-6 lg:p-8 overflow-y-auto space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-900 p-4 rounded-xl border border-slate-200/50 dark:border-gray-800 shadow-[0_4px_20px_rgb(0,0,0,0.02)] flex items-center space-x-4">
                    ...
                    <div><span class="text-[10px] font-bold text-brand-muted dark:text-gray-400 uppercase tracking-wider block">Total</span><span class="text-xl font-extrabold text-brand-dark dark:text-white"><?php echo $total; ?></span></div>
                </div>
                <div class="bg-white dark:bg-gray-900 p-4 rounded-xl border border-slate-200/50 dark:border-gray-800 shadow-[0_4px_20px_rgb(0,0,0,0.02)] flex items-center space-x-4">
                    ...
                    <div><span class="text-[10px] font-bold text-brand-muted dark:text-gray-400 uppercase tracking-wider block">Unread</span><span class="text-xl font-extrabold text-brand-dark dark:text-white"><?php echo $unread; ?></span></div>
                </div>
                <div class="bg-white dark:bg-gray-900 p-4 rounded-xl border border-slate-200/50 dark:border-gray-800 shadow-[0_4px_20px_rgb(0,0,0,0.02)] flex items-center space-x-4">
                    ...
                    <div><span class="text-[10px] font-bold text-brand-muted dark:text-gray-400 uppercase tracking-wider block">Read</span><span class="text-xl font-extrabold text-brand-dark dark:text-white"><?php echo $read; ?></span></div>
                </div>
            </div>
    ...
    <div id="viewModal" class="fixed inset-0 modal-bg flex items-center justify-center z-50 hidden">
        <div class="bg-white dark:bg-gray-900 rounded-3xl w-full max-w-lg mx-4 shadow-2xl">
            <div class="flex items-center justify-between px-6 pt-6 pb-4 border-b border-slate-100 dark:border-gray-700">
                <h3 class="text-base font-extrabold text-brand-dark dark:text-white"><i class="fa-regular fa-envelope text-brand-pink mr-2"></i> Message Details</h3>
                <button onclick="closeViewModal()" class="text-brand-muted dark:text-gray-400 hover:text-brand-dark dark:hover:text-white text-lg"><i class="fa-solid fa-xmark"></i></button>
            </div>
            <div class="p-6 space-y-4" id="messageDetail">
                <div class="flex items-center gap-4 pb-4 border-b border-slate-100 dark:border-gray-700">
                    ...
                    <div>
                        <h4 id="modal-name" class="font-bold text-brand-dark dark:text-white"></h4>
                        <a id="modal-email" class="text-xs text-brand-pink hover:underline"></a>
                    </div>
                </div>
                <div>
                    <p class="text-xs font-bold text-brand-muted dark:text-gray-400 uppercase tracking-wider mb-2">Message</p>
                    <p id="modal-message" class="text-sm text-brand-dark dark:text-gray-300 bg-slate-50 dark:bg-gray-800 rounded-xl p-4 leading-relaxed"></p>
                </div>
                <p id="modal-date" class="text-xs text-brand-muted dark:text-gray-400"></p>
            </div>
            <div class="flex justify-end px-6 pb-6">
                <button onclick="closeViewModal()" class="px-5 py-2.5 bg-slate-100 hover:bg-slate-200 text-brand-dark dark:text-white dark:bg-gray-800 dark:hover:bg-gray-700 text-xs font-bold rounded-xl transition-all">Close</button>
            </div>
        </div>
    </div>
    ...
    <div id="deleteModal" class="fixed inset-0 modal-bg flex items-center justify-center z-50 hidden">
        <div class="bg-white dark:bg-gray-900 rounded-3xl w-full max-w-sm mx-4 shadow-2xl p-6 text-center">
            ...
            <h3 class="text-base font-extrabold text-brand-dark dark:text-white mb-2">Delete Message?</h3>
            <p class="text-xs font-medium text-brand-muted dark:text-gray-400 mb-6">This action cannot be undone.</p>
            <div class="flex justify-center gap-3">
                <button onclick="closeDeleteModal()" class="px-5 py-2.5 bg-slate-100 hover:bg-slate-200 text-brand-dark dark:text-white dark:bg-gray-800 dark:hover:bg-gray-700 text-xs font-bold rounded-xl transition-all">Cancel</button>
