...
<body class="bg-brand-lightPink dark:bg-gray-950 font-sans text-brand-dark dark:text-gray-100 antialiased">

<?php include '../includes/header.php' ?>


    <!-- HERO SECTION -->
    <section class="bg-brand-lightPink dark:bg-gray-900 relative overflow-hidden">
        <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-2 items-center pt-12 pb-20 md:py-24">
            <div class="space-y-6 max-w-xl z-10">
                ...
                <div class="flex space-x-4 pt-2">
                    ...
                    <button class="border border-brand-dark dark:border-gray-300 text-brand-dark dark:text-gray-200 px-6 py-3 rounded-md text-sm font-medium hover:bg-brand-dark hover:text-white transition">Explore Treatments</button>
                </div>
...
?>
    ...
    <section class="max-w-7xl mx-auto px-6 py-20">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-2xl overflow-hidden shadow-md border border-gray-100 dark:border-gray-800 transition-all duration-300 ease-out hover:-translate-y-2 hover:shadow-xl hover:border-pink-100 group">
                ...
                <div class="p-5">
                    <h3 class="font-serif text-lg text-brand-dark dark:text-white font-bold mb-2"><?php echo htmlspecialchars($t['treatment_name']); ?></h3>
                    <p class="text-xs text-brand-textMuted dark:text-gray-400 leading-relaxed mb-6"><?php echo htmlspecialchars($t['description'] ?? ''); ?></p>
    ...
    <section class="bg-[#FFF0F2] dark:bg-gray-900 py-16 border-t border-b border-pink-100/40 dark:border-gray-800">
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-pink-100/30 dark:border-gray-700 flex flex-col items-center justify-center text-center transition-transform duration-300 hover:-translate-y-1 hover:shadow-md">
                <div class="text-3xl mb-3 flex justify-center w-12 h-12 items-center bg-[#FFF0F2] dark:bg-gray-700 rounded-full"><i class="fa-regular fa-face-smile text-rose-400"></i></div>
            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-pink-100/30 dark:border-gray-700 flex flex-col items-center justify-center text-center transition-transform duration-300 hover:-translate-y-1 hover:shadow-md">
                <div class="text-3xl mb-3 flex justify-center w-12 h-12 items-center bg-[#FFF0F2] dark:bg-gray-700 rounded-full"><i class="fa-solid fa-user-doctor text-rose-400"></i></div>
                <h3 class="text-3xl font-bold text-gray-800 dark:text-white tracking-tight"><span class="counter" data-target="20">0</span>+</h3>
                <p class="text-xs text-gray-500 dark:text-gray-400 font-medium mt-1">Expert Doctors</p>
            </div>
            <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-pink-100/30 dark:border-gray-700 flex flex-col items-center justify-center text-center transition-transform duration-300 hover:-translate-y-1 hover:shadow-md">
                <div class="text-3xl mb-3 flex justify-center w-12 h-12 items-center bg-[#FFF0F2] dark:bg-gray-700 rounded-full"><i class="fa-solid fa-sparkles text-rose-400"></i></div>
                <h3 class="text-3xl font-bold text-gray-800 dark:text-white tracking-tight"><span class="counter" data-target="50">0</span>+</h3>
                <p class="text-xs text-gray-500 dark:text-gray-400 font-medium mt-1">Treatments</p>
            </div>
            <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-pink-100/30 dark:border-gray-700 flex flex-col items-center justify-center text-center transition-transform duration-300 hover:-translate-y-1 hover:shadow-md">
                <div class="text-3xl mb-3 flex justify-center w-12 h-12 items-center bg-[#FFF0F2] dark:bg-gray-700 rounded-full"><i class="fa-solid fa-award text-rose-400"></i></div>
                <h3 class="text-3xl font-bold text-gray-800 dark:text-white tracking-tight"><span class="counter" data-target="5">0</span>+</h3>
    ...
    <section class="max-w-7xl mx-auto px-6 py-12">
        <div class="text-center mb-12">
            ...
            <h2 class="font-serif text-3xl text-brand-dark dark:text-white">Real Stories, Real Results</h2>
        </div>
        <div class="grid md:grid-cols-3 gap-6 relative">
            <?php if (!empty($reviews)): ?>
                <?php foreach ($reviews as $review): ?>
                    <div class="bg-white dark:bg-gray-900 p-6 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm space-y-4">
                        ...
                        <p class="text-xs text-brand-textMuted dark:text-gray-400 italic leading-relaxed">"<?= htmlspecialchars($review['review_text']) ?>"</p>
                    </div>
                <?php endforeach; ?>
            <?php else: ?>
    ...
    <section class="max-w-7xl mx-auto px-6 py-16">
        <div class="flex justify-between items-end mb-10">
            <div>
                ...
                <h2 class="font-serif text-3xl text-brand-dark dark:text-white">Skincare Tips & Latest Updates</h2>
            </div>
            <a href="#" class="text-brand-pink font-semibold text-sm hover:underline">View All Blog Posts →</a>
        </div>
        <div class="grid md:grid-cols-3 gap-6">
            <div class="flex space-x-4 bg-white dark:bg-gray-900 p-3 rounded-lg border border-gray-50 dark:border-gray-800 shadow-xs">
                ...
                <div class="flex flex-col justify-between py-1">
                    <div>
                        ...
                        <h4 class="font-semibold text-xs mt-1 text-brand-dark dark:text-white line-clamp-2">5 Skincare Tips for Healthy, Glowing Skin</h4>
                    </div>
                    <span class="text-[10px] text-gray-400 dark:text-gray-500">May 10, 2026</span>
                </div>
            </div>
            <div class="flex space-x-4 bg-white dark:bg-gray-900 p-3 rounded-lg border border-gray-50 dark:border-gray-800 shadow-xs">
                ...
                <div class="flex flex-col justify-between py-1">
                    <div>
                        ...
                        <h4 class="font-semibold text-xs mt-1 text-brand-dark dark:text-white line-clamp-2">Benefits of Hydra Facial Treatment</h4>
                    </div>
                    <span class="text-[10px] text-gray-400 dark:text-gray-500">May 05, 2026</span>
                </div>
            </div>
            <div class="flex space-x-4 bg-white dark:bg-gray-900 p-3 rounded-lg border border-gray-50 dark:border-gray-800 shadow-xs">
                ...
                <div class="flex flex-col justify-between py-1">
                    <div>
                        <span class="text-[10px] font-semibold text-brand-pink uppercase tracking-wider">Skincare Tips</span>
                        <h4 class="font-semibold text-xs mt-1 text-brand-dark dark:text-white line-clamp-2">How to Protect Your Skin from Sun Damage</h4>
                    </div>
                    <span class="text-[10px] text-gray-400 dark:text-gray-500">Apr 28, 2026</span>
                </div>
            </div>
        </div>
    </section>
...
<!-- PREMIUM CONTACT US SECTION -->
    <section class="max-w-7xl mx-auto px-6 py-20 bg-white dark:bg-gray-950">
            ...
            <div class="lg:col-span-6 p-8 md:p-14 flex flex-col justify-between bg-white dark:bg-gray-900 z-10">
                ...
                <form class="space-y-3.5 max-w-md mx-auto w-full" onsubmit="event.preventDefault();">
                    ...
                    <div class="relative flex items-center">
                        <input type="text" placeholder="Your Name" class="w-full text-xs px-4 py-3.5 bg-brand-lightPink/10 dark:bg-gray-800 border-2 border-pink-100/60 dark:border-gray-700 rounded-lg placeholder-gray-400 dark:placeholder-gray-500 outline-none focus:outline-none focus:border-brand-pink focus:ring-1 focus:ring-brand-pink/30 transition-all font-light text-brand-dark dark:text-gray-200">
                    </div>

                    <!-- Email Input -->
                    <div class="relative flex items-center">
                        <input type="email" placeholder="Email Address" class="w-full text-xs px-4 py-3.5 bg-brand-lightPink/10 dark:bg-gray-800 border-2 border-pink-100/60 dark:border-gray-700 rounded-lg placeholder-gray-400 dark:placeholder-gray-500 outline-none focus:outline-none focus:border-brand-pink focus:ring-1 focus:ring-brand-pink/30 transition-all font-light text-brand-dark dark:text-gray-200">
                    </div>

                    <!-- Phone Number Input -->
                    <div class="relative flex items-center">
                        <input type="tel" placeholder="Phone Number" class="w-full text-xs px-4 py-3.5 bg-brand-lightPink/10 dark:bg-gray-800 border-2 border-pink-100/60 dark:border-gray-700 rounded-lg placeholder-gray-400 dark:placeholder-gray-500 outline-none focus:outline-none focus:border-brand-pink focus:ring-1 focus:ring-brand-pink/30 transition-all font-light text-brand-dark dark:text-gray-200">
                    </div>
                    ...
                    <div class="relative flex items-start">
                        <textarea rows="4" placeholder="Your Message" class="w-full text-xs px-4 py-3.5 bg-brand-lightPink/10 dark:bg-gray-800 border-2 border-pink-100/60 dark:border-gray-700 rounded-lg placeholder-gray-400 dark:placeholder-gray-500 outline-none focus:outline-none focus:border-brand-pink focus:ring-1 focus:ring-brand-pink/30 resize-none transition-all font-light text-brand-dark dark:text-gray-200"></textarea>
                    </div>
