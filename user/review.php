...
<body class="bg-[#FFF0F2]/40 min-h-screen flex items-center justify-center p-4 md:p-8">

    <!-- Main Outer Container Dashboard Card -->
    <div class="bg-white max-w-5xl w-full p-8 md:p-14 rounded-[2.5rem] shadow-[0_20px_50px_rgba(255,101,132,0.04)] border border-pink-100/30 grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 items-center">
