...
<!-- Hero Section -->
<section class="relative min-h-[751px] flex items-center pt-8 md:pt-0 overflow-hidden opacity-100 transition-opacity animate-in fade-in slide-in-from-bottom-8 duration-1000">
...
<!-- Features Section -->
<section class="py-section-gap bg-surface-container-lowest opacity-100 transition-opacity animate-in fade-in slide-in-from-bottom-8 duration-1000">
...
<section class="py-section-gap overflow-hidden opacity-100 transition-opacity animate-in fade-in slide-in-from-bottom-8 duration-1000">
...
<div class="flex flex-row gap-6 px-margin-mobile max-w-container-max mx-auto overflow-x-auto hide-scrollbar pb-8 flex-nowrap">
<!-- Treatment Card 1 -->
...
<section class="py-section-gap opacity-100 transition-opacity animate-in fade-in slide-in-from-bottom-8 duration-1000">
<div class="max-w-container-max mx-auto px-margin-mobile">
...
<!-- Testimonials -->
<section class="py-section-gap overflow-hidden relative opacity-100 transition-opacity animate-in fade-in slide-in-from-bottom-8 duration-1000">
...
<li class=""><a class="text-on-surface-variant font-label-md text-label-md hover:text-primary transition-colors" href="#">About Us</a></li>
<li class=""><a class="text-on-surface-variant font-label-md text-label-md hover:text-primary transition-colors" href="#">Treatments</a></li>
<li class=""><a class="text-on-surface-variant font-label-md text-label-md hover:text-primary transition-colors" href="#">Our Doctors</a></li>
<li class=""><a class="text-on-surface-variant font-label-md text-label-md hover:text-primary transition-colors" href="#">Results</a></li>
<li class=""><a class="text-on-surface-variant font-label-md text-label-md hover:text-primary transition-colors" href="#">Contact</a></li>
</ul>
</div>
<!-- Contact Info -->
...
<span class="">© 2024 Skin Clinic. All Rights Reserved.</span>
...
<script>
    ...
    document.querySelectorAll('.stat-counter').forEach(counter => counterObserver.observe(counter));
</script>
